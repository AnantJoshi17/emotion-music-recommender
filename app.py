...
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Circular+Std:wght@400;700&family=Montserrat:wght@400;600;700;900&display=swap');
    ...
    * { font-family: 'Montserrat', sans-serif; }
    ...
    /* Checkbox */
    .stCheckbox label { color: #ffffff !important; font-weight: 600; }
...
with col2:
    ...
    if emotion:
        ...
        <div style="text-align:center; margin-top:80px;">
            ...
            <div style="color:#ffffff; font-size:1.5rem; font-weight:700; margin-top:20px;">
                Detect your mood
            </div>
